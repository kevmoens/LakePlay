...
{
    public class TriviaForCheeseHeadsCosmosRepo : ITriviaForCheeseHeadsRepo<TriviaQuestion>
    {
        private readonly TriviaForCheeseHeadsCosmosContext _context;
        private SemaphoreSlim _semaphore = new SemaphoreSlim(1, 1);
        public TriviaForCheeseHeadsCosmosRepo(TriviaForCheeseHeadsCosmosContext context)
        {
            _context = context;
        }
